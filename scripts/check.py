...
def check(path: Path, family: str, full: bool):
    ...
    assert all(c in cmap for c in [*range(0x30A1, 0x30FB), *range(0x31F0, 0x3200), 0x3099, 0x309A, 0x309B, 0x309C, 0x30F0, 0x30F1, 0x30F2, 0x30F4, 0x1B127, 0x1B128, 0x2A708, 0x1B124, 0x1B125, 0x30FF, 0x1B122, 0x1B121, 0x1B126, 0x1B155, *range(0x1B164, 0x1B169), 0x1B120, 0x1AFF0, 0x1AFF1, 0x1AFF2, 0x1AFF3, 0x1AFF5, 0x1AFF6, 0x1AFF7, 0x1AFF8, 0x1AFF9, 0x1AFFA, 0x1AFFB, 0x1AFFD, 0x1AFFE, 0x2CEFF])
    if not full:
    ...
    DIGRAPHS = {0x2A708: "トモ", 0x1B124: "トキ", 0x1B125: "トテ", 0x30FF: "コト", 0x1B126: "ヨリ", 0x2CEFF: "ナリ"}
