...
The selected form takes 𪜈's curved left stroke, with Klee One's テ set beside it the way the モ is set: its right edge 8 units short of the モ's right edge, its top bar cut off 0.34 of the way into the left stroke, its height 0.97 of the left stroke's, its width 0.83 of Klee's テ, and its vertical shift 4 units up. Strokes other than the bar keep 38 units clear of the left stroke. The part below the bar keeps 0.77 of 𪜈's left-stroke bend. The whole letter is scaled 1.053 about its centre and stretched 1.075 vertically. The same glyph occupies one 1000-unit cell in both directions, with vertical origin 880.

Eight rounds of comparison reduced the letter's two constructions to four leaders: one assembled from ト's upright beside a compressed テ, three on 𪜈's frame with テ set where the モ sits. The final round's 12 judgments are eight primary comparisons and four reversed repeats, all with horizontal and vertical reading samples shown together at 24 px. The selection takes candidate `c9fc3bb4e6b5d8a57` on comparisons among the four leaders across rounds 7 and 8, where it leads on points per comparison, 3.5/6 (0.58) against 2.5/5 (0.50), and won two of its three primary comparisons against the assembled form `cfb207b3b341d9ac2`, tying the third. The final round's scores alone put the assembled form first at 2.5/4, each of the three curved forms taking 1.5/4. The curved forms differ in `bend` (0.10, 0.53 and 0.77) and in width, fit and size: 0.10 and 0.53 each beat 0.77 in the final round while their own pair traded a 'neither' and a tie, so the comparisons do not isolate the bend. Repeats are excluded from ranking. One of the four repeat judgments agreed with its first judgment, so the result supports a practical selection with limited repeat consistency. The final two rounds' ballots, the finalists' designs, scores and outline hashes are in `votes/tote/`.
