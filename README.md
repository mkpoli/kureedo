...
@font-face {
  ...
  font-display: swap;
  unicode-range: U+3000-303F, U+3099-309C, U+30A0-30FF, U+31F0-31FF, U+1B000, U+1B127-1B128, U+2A708, U+1B124, U+1B125, U+1B122, U+1B121, U+1B126, U+1B155, U+1B164-1B168, U+1B120, U+1AFF0-1AFFE, U+2CEFF, U+2CF00;
}
...
**𬻿 from ヽ and し.** The ナリ ligature ([L2/24-150](https://www.unicode.org/L2/L2024/24150-three-kana-ligatures.pdf)), which the code chart draws as a short stroke over a low sweep to the right: ヽ at 0.5 over the foot of Klee's し stretched to 1.5 of its width; `hlig` forms it from ナリ.
